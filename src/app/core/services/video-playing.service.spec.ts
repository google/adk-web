...
describe('VideoPlayingService', () => {
  ...
  beforeEach(() => {
    ...
    // objectUrlFromSafeSource branches on `instanceof MediaSource`, so the fake
    // has to inherit from the stubbed constructor to be treated as a stream
    // rather than as a Blob.
    Object.setPrototypeOf(mediaSource, MediaSource.prototype);
