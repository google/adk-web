...
describe('ComputerActionComponent', () => {
  ...
  describe('Coordinate Scaling', () => {
    ...
    it('should calculate actual pixel coordinates when image dimensions are known', () => {
      component.message = {
        functionCall: {
          name: ComputerTool.COMPUTER,
          args: {
    ...
    it('should find the last available screenshot in history', () => {
      ...
      component.allMessages = [
        ...
        },
        {
          functionCall: {
            name: 'computer',
            args: { action: 'type_text', text: 'hello' }
          }
        }
      ];
